            ...
            <section className="py-16 border-b">
                <div className="mx-auto max-w-7xl px-2 sm:px-4 lg:px-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <a href="javascript:;" className="bg-white border border-gray-200 shadow-lg rounded-lg p-4 transition-transform transform hover:scale-105">
                            ...
                            <div className="mt-5">
                                <h6 className="font-medium text-xl leading-8 text-black mb-2 w-full">Skin care cream</h6>
                                <div className="flex items-center justify-between">
                                    <h6 className="font-semibold text-xl leading-8 text-sky-600">$74.99</h6>
                                    <button
                        ...
                        <a href="javascript:;" className="bg-white border border-gray-200 shadow-lg rounded-lg p-4 transition-transform transform hover:scale-105">
                            ...
                            <div className="mt-5">
                                <h6 className="font-medium text-xl leading-8 text-black mb-2 w-full">Men's Facial</h6>
                                <div className="flex items-center justify-between">
                                    <h6 className="font-semibold text-xl leading-8 text-sky-600">$25</h6>
